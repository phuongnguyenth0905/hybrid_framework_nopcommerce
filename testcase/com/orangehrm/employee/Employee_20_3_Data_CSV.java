...
import utilitiesConfig.CSVHelper;


@Listeners(AllureTestListener.class)
public class Employee_20_3_Data_CSV extends BaseTest {
	WebDriver driver;
	List<String[]> csvData;
	...
	public void beforeClass(String browserName, String urlValue) {
		...
		loginPage = PageGeneratorManager.getLoginPage(driver);
		 ...
		 csvData = CSVHelper.readCSV("testdata/DataTest.csv");
		 String[] row = csvData.get(1);
		firstName = row[0];
		lastName = row[1];
		editFirstName = row[2];
		editLastName = row[3];
...
//
		...
		workEmail = row[29];
		otheEmail = row[30];//"autoqa"+getRandom()+"@live.com";
//Job Details
